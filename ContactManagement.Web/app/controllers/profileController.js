'use strict';
app.controller('profileController', ['$scope', 'FileUploader', function ($scope, FileUploader) {

    // Uploader Plugin Code 
    var uploader = $scope.uploader = new FileUploader({
        url: window.location.protocol + '//' + window.location.host +
             window.location.pathname + '/api/profile/UploadFile'
    });
    ...
    uploader.filters.push({
        ...
        fn: function (item, options) {
            ...
            if (extension == "jpg" || extension == "jpeg" || extension == "png")
                ...
                alert('Invalid file format. Please select a file with jpg/jpeg/png or rtf format and try again.');
                return false;
            }
        }
    });
